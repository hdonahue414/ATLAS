  ...
  function installFinalBlockingFixes(){
    if(!document.getElementById('atlasFinalBlockingFixes')){
      ...
      style.textContent=`
        ...
        .practiceHeroBody .practicePick.programDossierNav .schoolBtn.active:before{background:var(--programAccent,var(--practiceAccent,#9de7d7))!important;box-shadow:0 0 12px var(--programAccent,var(--practiceAccent,#9de7d7))!important}
