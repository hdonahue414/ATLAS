  ...
  function installFinalBlockingFixes(){
    if(!document.getElementById('atlasFinalBlockingFixes')){
      ...
      style.textContent=`
        ...
        .schoolBtn{position:relative!important;background:rgba(5,9,20,.22)!important;border:1px solid rgba(255,255,255,.10)!important;border-radius:999px!important;color:rgba(220,231,247,.76)!important;padding:8px 11px 8px 22px!important;box-shadow:none!important;font-weight:400!important;font-size:.76rem!important;line-height:normal!important;white-space:nowrap!important;margin:0!important;transition:border-color .18s ease,background .18s ease,color .18s ease!important}
        .schoolBtn:before{content:""!important;position:absolute!important;left:9px!important;top:50%!important;width:5px!important;height:5px!important;border-radius:50%!important;transform:translateY(-50%)!important;background:rgba(220,231,247,.28)!important}
        .schoolBtn:hover,.schoolBtn:focus{border-color:rgba(157,231,215,.26)!important;background:rgba(157,231,215,.07)!important;color:#f4f8ff!important;outline:0!important}
        .schoolBtn.active{background:rgba(157,231,215,.11)!important;border-color:rgba(157,231,215,.36)!important;color:#fff!important;font-weight:700!important}
        .schoolBtn.active:before{background:var(--programAccent,var(--practiceAccent,#9de7d7))!important;box-shadow:0 0 12px var(--programAccent,var(--practiceAccent,#9de7d7))!important}
        @media(min-width:901px){.practiceHeroBody .practicePick.programDossierNav,.programDossierNav,.practicePick{flex-wrap:nowrap!important;gap:6px!important}.schoolBtn{padding:8px 8px 8px 18px!important;font-size:.76rem!important;white-space:nowrap!important}.schoolBtn:before{left:7px!important;width:4px!important;height:4px!important}}
